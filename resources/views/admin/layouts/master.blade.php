...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Admin-pp</title>

    <!-- FAVICONS ICON -->
    <link rel="shortcut icon" type="image/png" href={{ asset("asset-dolad/images/favicon.png") }}>
    <link rel="stylesheet" type="text/css" href={{ asset("asset-dolad/vendor/star-rating/star-rating-svg.css")}}>
    <link href={{ asset("asset-dolad/vendor/jquery-nice-select/css/nice-select.css")}} rel="stylesheet">
    <link href={{ asset("asset-dolad/vendor/jquery-autocomplete/jquery-ui.css")}} rel="stylesheet">
    <link href={{ asset("asset-dolad/css/style.css")}} rel="stylesheet">
...
<body>
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">List customer</a></li>
                    </ol>
                </div>
                <div class="row">
    ...
    <script src={{ asset("asset-dolad/vendor/global/global.min.js")}}></script>

    {{-- <script src={{ asset("asset-dolad/vendor/star-rating/jquery.star-rating-svg.js")}}></script> --}}
    {{-- <script src={{ asset("asset-dolad/vendor/jquery-nice-select/js/jquery.nice-select.min.js")}}></script> --}}
    {{-- <script src={{ asset("asset-dolad/vendor/jquery-autocomplete/jquery-ui.js")}}></script> --}}
    <script src={{ asset("asset-dolad/js/custom.min.js")}}></script>
    {{-- <script src={{ asset("asset-dolad/js/dlabnav-init.js")}}></script> --}}
    {{-- <script src={{ asset("asset-dolad/js/demo.js")}}></script> --}}
    {{-- <script src={{ asset("asset-dolad/js/styleSwitcher.js")}}></script> --}}
</body>
